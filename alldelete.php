...
<tr>
<td>
<a href="animal1.php"><img src=animal/panda3.jpg height=130px width=140px></a>
</td>
...
<tr>
<td> <a href="anidelete.php"><input type=button  value=Delete ></a></td>
<td> &nbsp;&nbsp;&nbsp;<a href="rdelete.php"><input type=button  value=Delete ></a></td>
<td> &nbsp;&nbsp;<a href="ppetdelete.php"><input type=button  value=Delete ></a></td>
<td> &nbsp;&nbsp;<a href="jwelerydelete.php"><input type=button  value=Delete ></a></td>
<td> &nbsp;&nbsp;<a href="babydelete.php"><input type=button  value=Delete ></a></td>
<td> &nbsp;&nbsp;<a href="kiddelete.php"><input type=button  value=Delete ></a></td>
<td>&nbsp;&nbsp; <a href="ladiesdelete.php"><input type=button  value=Delete ></a></td>
<td> &nbsp;&nbsp;<a href="showdelete.php"><input type=button  value=Delete ></a></td>
